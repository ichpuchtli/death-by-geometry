...
- **Render note:** the in-game `'dense'` variant no longer draws the tiny orbit-dot particles (sub-pixel at gameplay zoom); swirl arms + infall streaks carry the accretion motion.
